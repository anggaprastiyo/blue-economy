                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.user.fields.instansi') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.user.fields.jenis_instansi') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.user.fields.pendidikan_terakhir') }}
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="search" strict="true">
                                            ...
                                            @foreach(App\Models\User::JENIS_INSTANSI_RADIO as $key => $item)
                                    ...
                                    <td>
                                        <select class="search" strict="true">
                                            <option value>{{ trans('global.all') }}</option>
                                            @foreach(App\Models\User::PENDIDIKAN_TERAKHIR_SELECT as $key => $item)
                                                <option value="{{ $item }}">{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                            ...
                            <tbody>
                                @foreach($users as $key => $user)
                                    <tr data-entry-id="{{ $user->id }}">
                                        ...
                                        <td>
                                            {{ App\Models\User::JENIS_INSTANSI_RADIO[$user->jenis_instansi] ?? '' }}
                                        </td>
                                        <td>
                                            {{ App\Models\User::PENDIDIKAN_TERAKHIR_SELECT[$user->pendidikan_terakhir] ?? '' }}
                                        </td>
                                        <td>
