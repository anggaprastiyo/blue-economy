...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-contentPageComments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.comment.fields.content_page') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-contentPageComments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
