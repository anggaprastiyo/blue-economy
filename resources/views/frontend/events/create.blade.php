                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.events.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="location"
                                          id="location">{!! old('location') !!}</textarea>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="date" name="date" id="date" forma
                                    ...
                                    <div class="col-md-6">
                                        <label class="required" for="date">Jam</label>
