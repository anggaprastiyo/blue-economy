                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="instansi" id="instansi" value="{{ old('instansi', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::JENIS_INSTANSI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jenis_instansi_{{ $key }}" name="jenis_instansi" value="{{ $key }}" {{ old('jenis_instansi', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="alamat_instansi" id="alamat_instansi">{!! old('alamat_instansi') !!}</textarea>
