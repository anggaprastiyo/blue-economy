...
@section('content')
    @can('banner_slider_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.banner_sliders.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.banner_slider.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.banner_slider.title_singular') }} {{ trans('global.list') }}
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\BannerSlider::PUBLISH_STATUS_RADIO as $key => $item)
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            @can('banner_slider_delete')
            let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
            let deleteButton = {
                text: deleteButtonTrans,
                url: "{{ route('admin.banner_sliders.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.banner_sliders.index') }}",
                columns: [
