...
class CommentController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Comment::with(['content_page', 'user', 'created_by'])->select(sprintf('%s.*', (new Comment())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'content_page', 'user']);
        ...
        return view('admin.comments.index', compact('content_pages', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.comments.create', compact('content_pages', 'users'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        return view('admin.comments.edit', compact('comment', 'content_pages', 'users'));
    }
