...
<section id="locations" class="locations">
    ...
    <section id="tabs" class="tabs">
      ...
      <div class="section-title">
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          @foreach($events as $event)
            <li class="nav-item col-3">
              <a class="nav-link <?php if($count==0){ echo " active "; }?> show" data-bs-toggle="tab" data-bs-target="#tab-<?php echo $count+1 ;?>">
        ...
        ?>
        @foreach($events as $event)
          <div class="tab-pane <?php if($count==0){ echo " active "; }?> show" id="tab-<?php echo $count+1 ;?>">
            <div class="row">
