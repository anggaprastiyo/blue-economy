    ...
    <div class="container">
        <div class="row m-rl--1">
            <div class="col-md-6 p-rl-1 p-b-2">
                <div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url('{{ $latestArticle[1]['image']->url }}');">
            ...
            <div class="col-md-6 p-rl-1">
                <div class="row m-rl--1">
                    <div class="col-12 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url('{{ $latestArticle[2]['image']->url }}');">
                            <a href="{{url('articles/detail')}}" class="dis-block how1-child1 trans-03"></a>
                    ...
                    <div class="col-sm-6 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url('{{ $latestArticle[3]['image']->url }}');">
                            <a href="{{url('articles/detail')}}" class="dis-block how1-child1 trans-03"></a>
                            <div class="flex-col-e-s s-full p-rl-25 p-tb-20">
                                <h3 class="how1-child2 m-t-14">
                    ...
                    <div class="col-sm-6 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url('{{ $latestArticle[4]['image']->url }}');">
                            <a href="{{url('articles/detail')}}" class="dis-block how1-child1 trans-03"></a>
                            <div class="flex-col-e-s s-full p-rl-25 p-tb-20">
                                <h3 class="how1-child2 m-t-14">
                                    <a href="{{url('articles/detail')}}" class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
                        ...
                        <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                @foreach ($contentCategories as $category)
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('frontend.articles.all', ['slug'=>$category->slug]) }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
