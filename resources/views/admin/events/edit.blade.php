    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('detail') ? 'is-invalid' : '' }}" name="detail" id="detail">{!! old('detail', $event->detail) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('location') ? 'is-invalid' : '' }}" name="location" id="location">{!! old('location', $event->location) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Event::PUBLISH_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('publish_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="publish_status_{{ $key }}" name="publish_status" value="{{ $key }}" {{ old('publish_status', $event->publish_status) === (string) $key ? 'checked' : '' }}>
