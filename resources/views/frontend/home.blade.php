            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <li style="background:#fff"><a href="{{ url('articles/all') }}" style="color:#444;">Show More</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                @foreach ($articles as $article)
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="assets/img/portfolio/portfolio-<?php echo $count + 1; ?>.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>{{ substr($article->title, 0, 30) }}</h4>
                                <p>{{ substr($article->page_text, 0, 150) }}</p>
                                <div class="portfolio-links">
                                    <a href="assets/img/portfolio/portfolio-<?php echo $count + 1; ?>.jpg"
                        ...
                        <p>{{ substr($article->page_text, 0, 150) }}...</p>
                        <div style="text-align:center">
                            <a href="{{ url('articles/detail') }}" class="get-started-btn scrollto"
