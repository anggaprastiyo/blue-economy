...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.sliders.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-sliders">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-sliders').DataTable(dtOverrideGlobals);
