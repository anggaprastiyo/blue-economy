                ...
                <div class="p-b-20">
                    ...
                    <div class="tab01 p-b-20">
                        <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <!--  -->
                            <a href="{{url('articles/category-all')}}" class="tab01-link f1-s-1 cl9 hov-cl10 trans-03">
                                View all
                            ...
                            <div class="tab-pane fade show active" id="tab2-1" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="m-b-30">
                                            <a href="{{url('articles/detail')}}" class="wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-10.jpg')}}" alt="IMG">
                                            </a>
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-11.jpg')}}" alt="IMG">
                                            </a>
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-12.jpg')}}" alt="IMG">
                                            </a>
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-13.jpg')}}" alt="IMG">
                                            </a>
                            ...
                            <div class="tab-pane fade show active" id="tab3-1" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="m-b-30">
                                            <a href="{{url('articles/detail')}}" class="wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-14.jpg')}}" alt="IMG">
                                            </a>
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-15.jpg')}}" alt="IMG">
                                            </a>
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-16.jpg')}}" alt="IMG">
                                            </a>
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-17.jpg')}}" alt="IMG">
                                            </a>
                            ...
                            <div class="tab-pane fade" id="tab3-2" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{url('articles/detail')}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('assets/img/mag/post-18.jpg')}}" alt="IMG">
                                            </a>
