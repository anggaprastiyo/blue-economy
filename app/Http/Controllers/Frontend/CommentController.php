...
class CommentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.comments.create', compact('content_pages', 'parents', 'users'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        return view('frontend.comments.edit', compact('comment', 'content_pages', 'parents', 'users'));
    }
