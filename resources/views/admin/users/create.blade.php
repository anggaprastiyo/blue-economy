    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instansi') ? 'is-invalid' : '' }}" type="text" name="instansi" id="instansi" value="{{ old('instansi', '') }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::JENIS_INSTANSI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jenis_instansi') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jenis_instansi_{{ $key }}" name="jenis_instansi" value="{{ $key }}" {{ old('jenis_instansi', '') === (string) $key ? 'checked' : '' }} required>
                        <label class="form-check-label" for="jenis_instansi_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('alamat_instansi') ? 'is-invalid' : '' }}" name="alamat_instansi" id="alamat_instansi">{!! old('alamat_instansi') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pendidikan_terakhir') ? 'is-invalid' : '' }}" name="pendidikan_terakhir" id="pendidikan_terakhir" required>
                    ...
                    @foreach(App\Models\User::PENDIDIKAN_TERAKHIR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pendidikan_terakhir', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
