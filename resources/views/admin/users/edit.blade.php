    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instansi') ? 'is-invalid' : '' }}" type="text" name="instansi" id="instansi" value="{{ old('instansi', $user->instansi) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::JENIS_INSTANSI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jenis_instansi') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jenis_instansi_{{ $key }}" name="jenis_instansi" value="{{ $key }}" {{ old('jenis_instansi', $user->jenis_instansi) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('alamat_instansi') ? 'is-invalid' : '' }}" name="alamat_instansi" id="alamat_instansi">{!! old('alamat_instansi', $user->alamat_instansi) !!}</textarea>
